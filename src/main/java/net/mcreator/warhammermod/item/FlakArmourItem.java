...
public abstract class FlakArmourItem extends ArmorItem {
	public FlakArmourItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(WarhammerModModItems.CERAMITE.get()));
			}
	...
	public static class Helmet extends FlakArmourItem {
		public Helmet() {
	...
	public static class Chestplate extends FlakArmourItem {
		public Chestplate() {
	...
	public static class Leggings extends FlakArmourItem {
		public Leggings() {
	...
	public static class Boots extends FlakArmourItem {
		public Boots() {
